...
# additional string.)
SECRET_KEY = 'q2jde7xrbw5coj+9)emlrwv6yx0kz#k=^cqf^$#hc$otnvk^jpitvn'
SITE_SETTINGS_KEY = 'itvngeu=a(&!rv$swxa*&*2s%x(43p)(vpgp!j!f2v$h@bws@s^m7x'
...
DATABASES['default']['USER'] = 'itvn'
DATABASES['default']['PASSWORD'] = 'itvn'
DATABASES['default']['NAME'] = 'itvn'
...
# Set time zone to south african time
...
set_app_log_filename('/var/log/itvn/app.log')
set_debug_log_filename('/var/log/itvn/debug.log')
